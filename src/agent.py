...
INSTRUCTIONS = (
    ...
    "回答時のルール:\n"
    "- リリース情報 (GA / プレビュー / 廃止予定など) は MRC ツールを一次情報として呼び出すこと。\n"
    "- 製品の技術詳細・設定手順・ベストプラクティスなどドキュメント寄りの質問は、"
    "Microsoft Learn MCP を一次情報として使ってよい。\n"
    ...
    "- 最終的な回答は必ず日本語のテキストで返すこと。ツール結果が空・失敗・対象外でも"
    "空の応答にせず、分かる範囲で答えるか、情報が見つからない旨と次に確認すべき場所を必ず述べること。"
)
